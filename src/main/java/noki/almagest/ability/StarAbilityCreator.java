...
//		int[] original = nbtStack.getIntArray(nameAbility);
	...
	public static HashMap<Integer, ArrayList<Integer>> getAbility2(ItemStack stack) {
		
		HelperNBTStack nbtStack = new HelperNBTStack(stack);
		NBTTagCompound abilityTag = nbtStack.getTag("abilities");
		
		HashMap<Integer, ArrayList<Integer>> abilities = new HashMap<Integer, ArrayList<Integer>>();
